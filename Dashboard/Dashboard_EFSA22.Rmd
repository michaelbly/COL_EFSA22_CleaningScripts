---
title: 'WFP-CNC EFSA22: Recogida de Datos - 04/08/2022 10:30'
output:
...
dat <- read.csv("Input/efsa_all_data_2022-08-04.csv",
               stringsAsFactors = TRUE)

n_dat <- read.csv("Input/nutritional_data/nutritional_data_2022-08-04.csv",
               stringsAsFactors = TRUE)
...
survey_status_per_day$Fecha <- strptime(as.character(survey_status_per_day$Fecha), "%Y-%m-%d")
survey_status_per_day$Fecha <-  format(survey_status_per_day$Fecha, "%m/%d/%y")


library(plotly)
fig <- plot_ly(survey_status_per_day, x = ~Fecha, y = ~Aceptado, type = 'bar', name = 'Aceptado',
               marker = list(color = 'rgb(55, 83, 109)'))
fig <- fig %>% add_trace(y = ~Marcada_Tiempo, name = 'Marcado', marker = list(color = 'rgb(168, 56, 50)'))
...
write.csv(overall_merged, "Output/overall_merged_map.csv")
...
```{r eval=TRUE, fig.align = 'right', echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
fig
```
